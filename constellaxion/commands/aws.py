...
from constellaxion.terraform.core.display import (
    print_success, print_error, print_warning, print_info, print_resource_table
)
...
def list_resources(clean: bool):
    ...
    try:
        ...
        print_info(f"Scanning resources in region '{region}' using profile '{profile or 'default'}'...")
